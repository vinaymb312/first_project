  ...
  <div class="container-fluid mt-5text-center">
    <div class="row mt-5">
      ...
      <div class="col col-md-6 col-sm-6 ">
          ...
          <img src="public/images/correct.jpeg" alt="image" height="50px;" width="50px;" /><span style="margin: 30px;">Established vendor network for mechanical supplies</span><br />
          <img src="public/images/correct.jpeg" alt="image" height="50px;" width="50px;" /><span style="margin: 30px;">Cable & wire routing / installation</span><br />      
      </div>
    </div>
  </div>
  ...
  <div class="container text-center mt-5">
    <div class="row">
      <div class="col">
        <div class="card-body shadow p-3  rounded ">
          <div class="card-body">
            <h5 style="font-size: 18px;" class="card-title">Q1: We have already tried a lot. Does your method really work? <img style="float: right" src="public/images/plus.png" alt="image"></h5>
          </div>
        </div>
      ...
      <div class="col">
        ...
        <div style="margin-top:2%" class="card-body shadow p-3  rounded">
          ...
          <div class="card-body">
            <h5 style="font-size: 18px;" class="card-title">Q6: We have already tried a lot. Does your method really work? <img style="float: right" src="public/images/plus.png" alt="image"></h5>
          <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
            <a href="#" class="btn btn-primary">Go somewhere</a> -->
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="col mt-3 text-center">
        ...
        <div class="col mt-4 text-right">
          ...
          <img style="float: 80px; padding: 6px;" src="public/images/scoial-media.png" alt="image" height="80px" width="80px">
        </div>
      </div>
    </div>
